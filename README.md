...
Resolving google-search-results...
Added google-search-results to Pipfile's [packages] ...
✔ Installation Succeeded
Pipfile.lock (426a80) out of date, updating to (c90c71)...
Locking [packages] dependencies...
Building requirements...
Resolving dependencies...
✔ Success!
Locking [dev-packages] dependencies...
Updated Pipfile.lock (fb728a3c34bf38e9f34558b8746b7617e08071844d284cb745aa63f0b5c90c71)!
Installing dependencies from Pipfile.lock (c90c71)...
To activate this project's virtualenv, run pipenv shell.
Alternatively, run a command inside the virtualenv with pipenv run.
```
